...
//マクロ定義
#define TEXTURE_FILENAME_3D "data/Txt/Effect_Texture.txt"	//テクスチャ読み込みテキスト

//静的メンバ変数
LPDIRECT3DTEXTURE9 CBasis_Effect::m_pTexture[MAX_TEXTURE] = {};
int CBasis_Effect::m_nMaxTex = 0;

CBasis_Effect::CBasis_Effect() : CEffect_3D()
{

}

CBasis_Effect::~CBasis_Effect()
{

}

//初期化処理
HRESULT CBasis_Effect::Init(D3DXVECTOR3 size, D3DXVECTOR3 pos, D3DXVECTOR2 Tex)
{
...
//更新処理
void CBasis_Effect::Update()
{

}

//描画処理
void CBasis_Effect::Draw()
{
	LPDIRECT3DDEVICE9 pDevice; //デバイスのポインタ
	D3DXMATRIX mtxRot, mtxTrans, mtxWorld; //計算用マトリックス
	pDevice = CManager::GetInstance()->GetRenderer()->GetDevice();//デバイスのポインタ
														//ラインティングを無視する
...
// テクスチャ破棄
//=============================================================================
void CBasis_Effect::UninitTexture()
{
	//テクスチャ破棄
...
//作成
CBasis_Effect *CBasis_Effect::Create(D3DXVECTOR3 size, D3DXVECTOR3 pos, D3DXVECTOR2 Tex)
{
	CBasis_Effect *pBasis_Effect;
	pBasis_Effect = new CBasis_Effect();
	if (pBasis_Effect != NULL)
	{
		pBasis_Effect->Init(size, pos, Tex);
	}
	return pBasis_Effect;
}

//=============================================================================
// サイズセット
//=============================================================================
void CBasis_Effect::SetSize(D3DXVECTOR3 size)
{
	//m_size = size;
	VERTEX_3D *pVtx; //頂点情報へのポインタ
					 //頂点バッファをロックし、頂点データへのポインタを取得
...
// 色セット
//=============================================================================
void CBasis_Effect::ChangeColor(D3DXCOLOR col)
{
	VERTEX_3D *pVtx; //頂点情報へのポインタ
					 //頂点バッファをロックし、頂点データへのポインタを取得
	m_pVtxBuff->Lock(0, 0, (void **)&pVtx, 0);
...
// テクスチャ生成
//=============================================================================
void CBasis_Effect::CreateTextureFile()
{
	// 頂点情報を設定
	LPDIRECT3DDEVICE9 pDevice = CManager::GetInstance()->GetRenderer()->GetDevice();//デバイスのポインタ
...
//カラー変更
//=============================================================================
void CBasis_Effect::ColorChange(D3DCOLORVALUE color)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
...
//サイズ変更
//=============================================================================
void CBasis_Effect::ChangeSize(D3DXVECTOR3 size)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
...
//平面エフェクト
//=============================================================================
void CBasis_Effect::SetPosField(D3DXVECTOR3 pos, D3DXVECTOR3 Size, float Rotate, float Rotate2)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
...
//サイズ変更
//=============================================================================
void CBasis_Effect::BillboardSize(float size)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
...
//テクスチャ移動
//=============================================================================
void CBasis_Effect::TexturMove(D3DXVECTOR2 MoveTex)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
	m_TexMove += MoveTex;
...
//テクスチャパターン
//=============================================================================
void CBasis_Effect::SetTexAnim(D3DXVECTOR2 TexPattern, D3DXVECTOR2 TexAnimSize)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
...
//座標
//=============================================================================
void CBasis_Effect::SetPosBill(D3DXVECTOR3 pos, D3DXVECTOR3 pos2, D3DXVECTOR3 pos3, D3DXVECTOR3 pos4)
{
	VERTEX_3D*pVtx;//頂点情報へのポインタ
	//頂点バッファをロックし、頂点データへのポインタを取得
	m_pVtxBuff->Lock(0, 0, (void**)&pVtx, 0);
