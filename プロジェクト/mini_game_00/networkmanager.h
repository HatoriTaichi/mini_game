...
public:
	...
	void CreateRecvThread(void) { thread recv_th(Recv); recv_th.detach(); }	// スレッドの生成
	...
	static CCommunicationData *GetEnemyData(void) { return &m_enemy_data; }	// 敵情報の取得
	static CTcpClient *GetCommunication(void) { return m_communication; }	//通信クラス取得処理
	static void DataReset(void);	// 初期化
	static bool GetAllConnect(void);	// 全体の接続確認
private:
