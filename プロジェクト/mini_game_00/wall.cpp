...
CWall::CWall(LAYER_TYPE layer) : CObject(layer)
{
...
//-------------------------------------------------------------------------------------------------
CWall *CWall::Create(D3DXVECTOR3 pos, D3DXVECTOR3 size,
	D3DXVECTOR3 rot, int nNum_X, int nNum_Y, string tex_pas)
{
	//インスタンス生成
	...
	pField->m_pTexture = CManager::GetInstance()->GetTexture()->GetTexture(tex_pas);
...
// 壁の当たり判定
//=============================================================================
bool CWall::Collision(D3DXVECTOR3 *pPos, D3DXVECTOR3 *pLastpos, float fRadius)
{
...
bool CWall::Collision2(D3DXVECTOR3 pos, D3DXVECTOR3 lastpos, float fRadius)
{
	bool bHit = false;//当たったかどうかを返す
					  //現在のデータ
	D3DXVECTOR3 NorAsk;//法線
...
{
	SetObjType(CObject::OBJTYPE::WALL);
