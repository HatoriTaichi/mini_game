...
// コンストラクタ
//=============================================================================
CBillEffect::CBillEffect() : CBasis_Effect()
{
	m_Color = {};
	m_MinColor = {};
}
...
{
	CBasis_Effect::Init(Size, D3DXVECTOR3(0.0f, 0.0f, 0.0f), TexNum);
	SetTexture(nTex);
	...
	CBasis_Effect::ColorChange(m_Color);
	CBasis_Effect::TexturMove(m_TexSize);
	CBasis_Effect::SetTexAnim(m_nSplit, m_PatternSize);
